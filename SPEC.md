...
- **Pendiente / guardado para después:** JFC mandó una hoja adicional de elementos cyborg (consola DJ, boombox, disco ball, cóctel, trompeta, láser, audífonos — *"para la página en general y en adelante para varios usos"*) que todavía no se integró a ningún lado. Encaja naturalmente con el roadmap de "Lounge virtual con streams/DJs" — cuando se construya esa sección, usar esos elementos ahí. No se guardó en el repo (se procesó y descartó por error durante esta tanda); pedir a JFC que la reenvíe cuando se vaya a construir esa sección. `grid4.png`/`grid5.png`/`grid6.png` en la raíz del repo sí quedaron como fuente original de los avatares, por si hace falta re-recortar algo.
